  ...
  collections: {
    ...
    Transactions: {
    	tableColumns: [
            ...
            {label: 'Seller\'s Zip', name: 'seller_profile.address'},
            {label: 'Seller\'s City', name: 'seller_profile.address'},
            {label: 'Seller\'s Country', name: 'seller_profile.address'},
            {label: 'Buyer\'s Email', name: 'buyer_profile.email'},
            {label: 'Buyer\'s Address', name: 'buyer_profile.address'},
            {label: 'Buyer\'s Zip', name: 'buyer_profile.address'},
            {label: 'Buyer\'s City', name: 'buyer_profile.address'},
            {label: 'Buyer\'s Country', name: 'buyer_profile.address'},
